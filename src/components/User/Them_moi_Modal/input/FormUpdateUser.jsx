...
const FormUpdateUser = (initValue) => {
    ...
    <>
      ...
      >
        ...
        <Form.Item
          className="mb-1"
          name="cmnd"
          initialValue={initValue.initValue.cmnd}
        ...
        <Form.Item
          className="mb-1"
          name="cap_bac"
          initialValue={initValue.initValue.cap_bac}
        ...
        <Form.Item
          className="mb-1"
          name="chuc_vu"
          initialValue={initValue.initValue.chuc_vu}
        ...
        <Form.Item
          className="mb-1"
          name="dia_chi"
          initialValue={initValue.initValue.dia_chi}
        ...
        <Form.Item
          ...
          initialValue={initValue.initValue.password_confirmation}
        ...
        <Form.Item
          className="mb-1"
          name="role_ids" 
          initialValue={initValue.initValue.role_ids}
          label="Vai trò">
            <Select
              mode="multiple"
              tagRender={tagRender}
          ...
          <Form.Item
            className="mb-1" 
            name="group_id" 
            initialValue={initValue.initValue.group_id}
            label="Nhóm dữ liệu">
            <Select
              mode="single"
              tagRender={tagRender}
